...
const validatePlace = require('../validations/places')
...
router.post('/form', validatePlace, asyncHandler(async function (req, res) {
...
router.put('/edit/:id', validatePlace, asyncHandler(async function (req, res) {
